    ...
    <div class="participant_y">
        ...
        <div v-if="list && list.length"
            ...
            <div class="all_checked"
                 @click.stop="allChange(allSelected)">
        ...
        <div v-else
             class="center_list">
            <p v-if="searchValue != ''"
               class="list_empty">没有搜到～～</p>
            <p v-else
               class="list_empty">项目中暂无人员，点击
                <span class="mainColor_text"
                      @click.stop="invitePeople">邀请好友</span>添加人员</p>
        </div>
        <div class="participant_bottom">
            <button class="main_button_"
                    @click.stop="invitePeople">邀请好友</button>
            <button class="main_button_bg"
                    @click.stop="sure">确定</button>
        </div>
